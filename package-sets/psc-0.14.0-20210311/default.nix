...
{ pkgs, ... }:
{
  ...
  "indexed-monad" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "f2880ef14c286e1f699042585d3c67d68e96b60e";
      "sha256" = "1wn68m03ypq86jf6p0avgmnd4nqqgfzsmbg7fcfidb7xl3l62v1h";
  ...
  "justifill" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "654e1ab623ff4f112a7cff4119d9db0d83b92a16";
      "sha256" = "175fml0fj3skvqa6x37gqbxacdan103jg2157hfbppy00rk2zmna";
  ...
  "web-html" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "0fa9b8dbb55fcebdb614568ead6bc87d7c88c667";
      "sha256" = "0kck96cny5wld4yzg79g7xhiz0psaj3wb3q3xmjzq847fq29gzf9";
