...
{ pkgs, ... }:
{
  ...
  "fast-vect" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "ec58ca57fedf8b1a15fd53f4054352fc7c72f572";
      "sha256" = "0wp0vc7z2y6ybq4dmnd5gvzrsrzi6ksz4i3aiiz653qq15dwkzgq";
  ...
  "phaser" = pkgs.stdenv.mkDerivation {
    ...
    "src" = pkgs.fetchgit {
      ...
      "sha256" = "0n54djjmfca8inrp4s3nyq09v5wr4afv5y5plbznx0jl02g1289p";
