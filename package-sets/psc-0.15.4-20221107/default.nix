...
{ pkgs, ... }:
{
  ...
  "react-basic-storybook" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "4f2b70e1e6b9260ea8e1c746b96e4688536f23d0";
      "sha256" = "12y33hcbj6k6yyc3y8dnksra0nhlksblwryf82adb76r5a6i1dmc";
  ...
  "tecton" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "e97efc5e6243f5f78213c6637e56ba09987da7f9";
      "sha256" = "16c1i7a1d1s5phc7bzgb43bchgva1x9l1wr6yqnanycg84zdbynm";
