...
{ pkgs, ... }:
{
  ...
  "quantities" = pkgs.stdenv.mkDerivation {
    ...
    "src" = pkgs.fetchgit {
      ...
      "sha256" = "0gcgv3jzhqvcwgghfzcws0r6kw9jkav486a5m4flbdbkb4ds9g4z";
  ...
  "react-icons" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "823fc834e4391b8ac7be0a7f12361a86a981b84a";
      "sha256" = "03i0n8agd0j5dbkasbvs9zac5pncxrl1lcrf7xakx41ifnjvnvxh";
