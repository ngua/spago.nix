...
{ pkgs, ... }:
{
  ...
  "typelevel-lists" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "9a27388a8a26abd971028466ec5b115dd34200bd";
      "sha256" = "15ris64d8z718lnvk0sjmpqmlvdrzzwmaddh0r0xab7b2dn620j3";
  ...
  "veither" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "dcc7850e6457f4039e24a1806c9e42f6b49b4faf";
      "sha256" = "19hnpg95qjq96l6m0jzlq2kzfc6286fa9sp7frkqvcgf2gapxdlk";
