...
{ pkgs, ... }:
{
  ...
  "aws-sdk-basic" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "a7ca6564400fea2b93762abc7d63cd2ad5a443af";
      "sha256" = "18n4l0p210amq8z97vw6fc38yd0j76dc5fxkcpldq6nlfi275n7d";
  ...
  "elmish" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "7a501310d01b0fc446a8eaf974da9b8454f984b9";
      "sha256" = "1svk9zzkamm2lp6hlh9k0d1x5jbk5ljzv9jgmmsw20hf1fx923px";
  ...
  "elmish-html" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "f7c5a68e7e1ff92a4f3af312df9413f7d0f4fa3b";
      "sha256" = "1198jmsxwnk03dlf2fcz49kf59ilcr6lyhqgkhw9fk10m6whcy86";
