...
{ pkgs, ... }:
{
  ...
  "barlow-lens" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "fe9142b2c7b86973627434f9e4fa53c92ac722db";
      "sha256" = "1q7waxk0034g1c28i05ik0rgjy3scf0m1sx6psxd781hjk59ykii";
  ...
  "pretty-logs" = pkgs.stdenv.mkDerivation {
    ...
    "src" = pkgs.fetchgit {
      ...
      "url" = "https://github.com/PureFunctor/purescript-pretty-logs";
    };
    "version" = "v0.1.0";
  };
