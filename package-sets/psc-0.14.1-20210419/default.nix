...
{ pkgs, ... }:
{
  ...
  "barlow-lens" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "156ef1059263830c5aa4118aac3ced170e77b6c9";
      "sha256" = "0s9689600yr614hv1w6p28ilrv24ikjp933za81a4hlk4my9l4fl";
  ...
  "react-basic-dom" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "85214f64ff27334cc3c3a2ce060ed2e82da0cc83";
      "sha256" = "16nhrr7cwxfsr1ljmj47v8jpbd63zkjl2lqm099lydhffnishs1p";
