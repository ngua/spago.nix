...
{ pkgs, ... }:
{
  ...
  "functors" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "81ac75e1a8206d38586e60b69ff8d6c3cd7cecb8";
      "sha256" = "19si98pwsclkxsrxhfa5klwmc10rywl7j9g692ffhbwr0bqiwk7l";
  ...
  "halogen" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "cbb4e7ffad6a177843bc2e7d9fb2079dabdc15ec";
      "sha256" = "0v102a7ilmccrjh3s600z4320hj69lalrxy2arn5cyxkpb2rnnd9";
  ...
  "wire" = pkgs.stdenv.mkDerivation {
    "installPhase" = "ln -s $src $out";
    "name" = "wire";
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "a38a1c7e5e119e6180e9e2bd86f4b3f7fd756398";
      "sha256" = "16vc0lwv3g5f5893b7rra4jnflfmhcabpvl3jk8699wna0yndar6";
      "url" = "https://github.com/robertdp/purescript-wire.git";
    };
    "version" = "v0.5.0";
  };
