...
{ pkgs, ... }:
{
  ...
  "array-search" = pkgs.stdenv.mkDerivation {
    "installPhase" = "ln -s $src $out";
    "name" = "array-search";
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "3c6946d612202887d4dc8ed55cf36f8f33a538c8";
      "sha256" = "038yjndg6n3fipivks4p6zwf82b9va74k4q6lxf43ay6sh1nqny7";
      "url" = "https://github.com/joellefkowitz/array-search.git";
    };
    "version" = "v0.5.6";
  };
  ...
  "assert-multiple" = pkgs.stdenv.mkDerivation {
    "installPhase" = "ln -s $src $out";
    "name" = "assert-multiple";
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "9cef3c59f91dd32e66e649de3c42cb8549bc84fe";
      "sha256" = "0krclnipx3ffkkfvfrlklg1xblhm9dz2hyifzksqkwsq9a8yjwfn";
      "url" = "https://github.com/joellefkowitz/assert-multiple.git";
    };
    "version" = "v0.3.4";
  };
  ...
  "bolson" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "7e65eef4f149b279c891c86896ae848b9e1a7cd5";
      "sha256" = "1fwj409v0q76xraca2mz8z3shcn5mhh01kq9wv0nj132vp7480ii";
  ...
  "deku" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "23240eaa80c3c5ab9e59bf99cf58751bb677a804";
      "sha256" = "1fhdyy712k4sk0ds7309hlz5b189m040z4ydnpvzm91jfpcad6hv";
  ...
  "dotenv" = pkgs.stdenv.mkDerivation {
    ...
    "src" = pkgs.fetchgit {
      ...
      "sha256" = "0mby4g9izfpwrh544w45bc7nddq23zacclv49965h6gyfg0cd3wb";
  ...
  "env-names" = pkgs.stdenv.mkDerivation {
    "installPhase" = "ln -s $src $out";
    "name" = "env-names";
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "2235b1f3d51edb1ace29a4ea53f41db90b08ce3c";
      "sha256" = "08hnk2h4i3dkxr1c77nm8cas4v9swp6ynqzykdyyns30iy9vcrp0";
      "url" = "https://github.com/joellefkowitz/env-names.git";
    };
    "version" = "v0.3.4";
  };
  ...
  "hyrule" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "aaff88c817803bcd583386ed91e0c9b835b7cc8c";
      "sha256" = "1zi1dji0wc6xw03axpssjgb2fjnhis1z2bi54pv2zf1ayifjp93d";
  ...
  "indexed-db" = pkgs.stdenv.mkDerivation {
    "installPhase" = "ln -s $src $out";
    "name" = "indexed-db";
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "88cfff76f8fa27392a51b44a6bfd65a0b3a14f39";
      "sha256" = "0927rwkxm764bs3r6n2jrz97h42cz7hzabky7mkwb8xw5y45zxhk";
      "url" = "https://github.com/ilyakooo0/purescript-indexed-DB.git";
    };
    "version" = "v1.0.0";
  };
  ...
  "jelly" = pkgs.stdenv.mkDerivation {
    ...
    "src" = pkgs.fetchgit {
      ...
      "sha256" = "1prpl8jqs71965ywfs6zp62msrls8c62i325636c25zpg9s96yw9";
  ...
  "jelly-router" = pkgs.stdenv.mkDerivation {
    ...
    "src" = pkgs.fetchgit {
      ...
      "sha256" = "18440krryp06h3l5x07ylfbifgs9gir321srpfr42pj6dv6s5b50";
  ...
  "jelly-signal" = pkgs.stdenv.mkDerivation {
    ...
    "src" = pkgs.fetchgit {
      ...
      "sha256" = "0dypjhrvpa84knmkgps42njly3r97gbvxw1x0y9alqrkjm1xd816";
  ...
  "js-bigints" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "320db74766061bb7be02eebc5fa1ab13379a92ca";
      "sha256" = "1n7x21vdczjgs0w6sbn58zj7cmnbbsaw58pgq33yd9crj35y27p7";
  ...
  "language-cst-parser" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "a7ca658b4fee2a8f88a0446432789ddca7fbada4";
      "sha256" = "0w8pdr5zkxx9ic7hi1jadmsmfpmwh8s9liyys5x5hhnxqb97k3q4";
  ...
  "maps-eager" = pkgs.stdenv.mkDerivation {
    "installPhase" = "ln -s $src $out";
    "name" = "maps-eager";
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "bca19bd4f531f29546e32e1f204e31f0c9afa02a";
      "sha256" = "042l9c3g0yx8gxzdlj8chmj36fryybjj6sz6p1rnxxqn91jhsd24";
      "url" = "https://github.com/joellefkowitz/maps-eager.git";
    };
    "version" = "v0.4.1";
  };
  ...
  "numberfield" = pkgs.stdenv.mkDerivation {
    "installPhase" = "ln -s $src $out";
    "name" = "numberfield";
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "2ca838c550ebd83ee2cdcec15a256be219a2a3c6";
      "sha256" = "19xybbhzfby1cdqi4iyzjdy5rc7q5svrfld7zr7ixy7f57c80jil";
      "url" = "https://github.com/Ebmtranceboy/purescript-numberfield.git";
    };
    "version" = "v0.1.0";
  };
  ...
  "pha" = pkgs.stdenv.mkDerivation {
    ...
    "src" = pkgs.fetchgit {
      ...
      "sha256" = "1y88gc3zd1cihr5cfzwmanqgi96kfhpdkjvjysjqfz16b18v38xy";
  ...
  "sparse-matrices" = pkgs.stdenv.mkDerivation {
    ...
    "src" = pkgs.fetchgit {
      ...
      "sha256" = "0gbbqzfp2g0y87hhhxa5nf1whpaahvpdy9fj1zs1djfclcn7skdd";
  ...
  "sparse-polynomials" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "9319228fef808b2f61d203dcea6aa878f57f86b4";
      "sha256" = "16vp390vcjdhcdhc0bsmv99rj9vzh768p1yij7l4kkakgs1jz77x";
  ...
  "transformation-matrix" = pkgs.stdenv.mkDerivation {
    "installPhase" = "ln -s $src $out";
    "name" = "transformation-matrix";
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "a1ae55769b520db18c0aa23d4577d8e277d7fdea";
      "sha256" = "04i6nph7r36mzl5kk3gy9xg3aqpdcgxmqf89k4llalr1946av6vc";
      "url" = "https://github.com/jstoxrocky/purescript-transformation-matrix.git";
    };
    "version" = "v1.0.0";
  };
  ...
  "typedenv" = pkgs.stdenv.mkDerivation {
    ...
    "src" = pkgs.fetchgit {
      ...
      "sha256" = "1jx7dwnsjxixzb9p5qgayhjks3lwn7gzyadrg4zd46pk2zw61fp8";
  ...
  "unique" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "7999c1815adeb9011124c7d54902b55f18c8f295";
      "sha256" = "07ln82h5cmrbf1gmllxrny5zk91fy53kp07ih23z8j44fgqsbm5x";
      "url" = "https://github.com/nsaunders/purescript-unique.git";
    };
    "version" = "v0.6.0";
  };
  ...
  "web-cssom-view" = pkgs.stdenv.mkDerivation {
    "installPhase" = "ln -s $src $out";
    "name" = "web-cssom-view";
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "8a4581e4a5eff76959e6e93838beb520083d7948";
      "sha256" = "1rj9grsc6rhs6zq1sm750cvm6y0g4gi09ky6jr3fp4d534cmsszj";
      "url" = "https://github.com/purescript-web/purescript-web-cssom-view.git";
    };
    "version" = "v0.1.0";
  };
  ...
  "web-geometry" = pkgs.stdenv.mkDerivation {
    "installPhase" = "ln -s $src $out";
    "name" = "web-geometry";
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "54991647c5a8108c65f52e749c5ecc31ef69f6db";
      "sha256" = "136g97jadfbs98vxcvcykyixkkkgfskhx5f71h25prpk99y3d6a0";
      "url" = "https://github.com/purescript-web/purescript-web-geometry.git";
    };
    "version" = "v0.1.0";
  };
  ...
  "webextension-polyfill" = pkgs.stdenv.mkDerivation {
    "installPhase" = "ln -s $src $out";
    "name" = "webextension-polyfill";
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "151dbeec894c80aec45afceed0406e6395edefc1";
      "sha256" = "1pfr8p9awlrjdc28yrwzn7h2fs2b0h1m8szsg31ddfw0ciy44lw0";
      "url" = "https://github.com/rowtype-yoga/purescript-webextension-polyfill.git";
    };
    "version" = "v0.1.0";
  };
  ...
  "yoga-json" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "3c30b89b20aa140823591814e463b2e8a7995598";
      "sha256" = "02s1rx209wfmgqdw6f9rsxxpf8rq0ii75m4p1jcfipsjmcnqp3vy";
