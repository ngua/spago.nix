...
{ pkgs, ... }:
{
  ...
  "bigintegers" = pkgs.stdenv.mkDerivation {
    "installPhase" = "ln -s $src $out";
    "name" = "bigintegers";
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "3a5bdc7ed4f523ac68d0eb66e9e215f38136a90e";
      "sha256" = "14c17m4qc843lfv6qaac3gydncmglfxcpjhn3dr7g1vh8ha8qb45";
      "url" = "https://github.com/Ebmtranceboy/purescript-bigintegers.git";
    };
    "version" = "v0.1.0";
  };
