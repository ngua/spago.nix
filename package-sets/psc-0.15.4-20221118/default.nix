...
{ pkgs, ... }:
{
  ...
  "bucketchain-csrf" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "6c7e657f61d25e86a110339e57c2719e3431407d";
      "sha256" = "0gsvdnch2nmhnzq74cjhncgcja3ny1zqnjdrf69r1fyvf1pgm3kx";
  ...
  "bucketchain-history-api-fallback" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "1f25e228c5352749f0a3cc2d9ebb20010a2691e2";
      "sha256" = "08yb6f6h767xhmabjn3cqjpmmxh12rrgmhajri6jmz4mdd9zz1vw";
  ...
  "bucketchain-sslify" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "2fa39482097f69720061f3a4ad5dc4343a73767c";
      "sha256" = "15n0cahyj5x0f8m7vkhjlasnxy91dd99dhl5xbj492bp9h0jr6wf";
