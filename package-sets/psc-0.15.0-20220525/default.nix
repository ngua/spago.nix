...
{ pkgs, ... }:
{
  ...
  "fast-vect" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "a26751d363acb41fa12a75f122c131aa3a3f06f8";
      "sha256" = "01spprqkalf1l42q5r510rk9dqg6lmf5xvf7nldn3knp5vrqawvg";
  ...
  "httpurple" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "be78b82445ceb96deaa372e803f117aeabb3f6d6";
      "sha256" = "185v7cf1vi2rpf2n894da3vrwaijipcqsbhm5317p33bf1lwiq4a";
