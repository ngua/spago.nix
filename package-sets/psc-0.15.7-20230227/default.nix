...
{ pkgs, ... }:
{
  ...
  "array-search" = pkgs.stdenv.mkDerivation {
    ...
    "src" = pkgs.fetchgit {
      ...
      "url" = "https://github.com/JoelLefkowitz/purescript-array-search.git";
    };
    "version" = "v0.5.6";
  };
  ...
  "assert-multiple" = pkgs.stdenv.mkDerivation {
    ...
    "src" = pkgs.fetchgit {
      ...
      "url" = "https://github.com/JoelLefkowitz/purescript-assert-multiple.git";
    };
    "version" = "v0.3.4";
  };
  ...
  "deku" = pkgs.stdenv.mkDerivation {
    ...
    "phases" = "installPhase";
    "src" = pkgs.fetchgit {
      "rev" = "23230d32660143e364363eda508689863b237274";
      "sha256" = "02wxrrk6xb91lq14ghy9z4nmfs65vyhrxr27ifl54x15fw7hgq7z";
  ...
  "maps-eager" = pkgs.stdenv.mkDerivation {
    ...
    "src" = pkgs.fetchgit {
      ...
      "url" = "https://github.com/JoelLefkowitz/purescript-maps-eager.git";
    };
    "version" = "v0.4.1";
  };
